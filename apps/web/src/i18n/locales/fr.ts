...
export const fr: Dict = {
  ...
  'settings.orbit.emptyBodyManual': 'Utilisez « Exécuter maintenant » dans l’en-tête pour lancer votre première exécution ; un détail des connecteurs et un live artifact actualisable apparaîtront ici.',
