...
export const fr: Dict = {
  ...
  'settings.connectorsHelpUnsaved': 'Modifications non enregistrées — cliquez sur Enregistrer pour stocker cette clé dans le daemon local et déverrouiller le catalogue ci-dessous.',
  ...
  'settings.orbit.runOpen': 'Exécuter et ouvrir',
  ...
  'settings.orbit.emptyAria': 'Orbit n’a pas encore été exécuté',
  'settings.orbit.emptyEyebrow': 'En attente de la première exécution',
  'settings.orbit.emptyTitle': 'Votre résumé quotidien apparaîtra ici',
  'settings.orbit.emptyBodyScheduled': 'Orbit est planifié — la prochaine exécution automatique publiera un live artifact et un détail de l’activité des connecteurs dans cette carte.',
  'settings.orbit.emptyBodyManual': 'Utilisez « Exécuter et ouvrir » dans l’en-tête pour lancer votre première exécution ; un détail des connecteurs et un live artifact actualisable apparaîtront ici.',
