...
export const de: Dict = {
  ...
  'settings.connectorsHelpUnsaved': 'Nicht gespeicherte Änderungen — klicke auf Speichern, um diesen Schlüssel im lokalen Daemon abzulegen und den Katalog unten zu entsperren.',
  ...
  'settings.orbit.runOpen': 'Ausführen & öffnen',
  ...
  'settings.orbit.emptyAria': 'Orbit wurde noch nicht ausgeführt',
  'settings.orbit.emptyEyebrow': 'Wartet auf ersten Lauf',
  'settings.orbit.emptyTitle': 'Deine tägliche Zusammenfassung erscheint hier',
  'settings.orbit.emptyBodyScheduled': 'Orbit ist geplant — der nächste automatische Lauf veröffentlicht ein live artifact und eine Aufschlüsselung der Connector-Aktivität in dieser Karte.',
  'settings.orbit.emptyBodyManual': 'Nutze „Ausführen & öffnen“ im Kopfbereich, um den ersten Lauf zu starten; eine Connector-Aufschlüsselung und ein aktualisierbares live artifact erscheinen hier.',
