...
export const esES: Dict = {
  ...
  'settings.connectorsHelpUnsaved': 'Cambios sin guardar — haz clic en Guardar para almacenar esta clave en el daemon local y desbloquear el catálogo de abajo.',
  ...
  'settings.orbit.runOpen': 'Ejecutar y abrir',
  ...
  'settings.orbit.emptyAria': 'Orbit aún no se ha ejecutado',
  'settings.orbit.emptyEyebrow': 'Esperando la primera ejecución',
  'settings.orbit.emptyTitle': 'Tu resumen diario aparecerá aquí',
  'settings.orbit.emptyBodyScheduled': 'Orbit está programado: la próxima ejecución automática publicará un live artifact y un desglose de actividad de conectores en esta tarjeta.',
  'settings.orbit.emptyBodyManual': 'Usa «Ejecutar y abrir» en el encabezado para iniciar tu primera ejecución; aquí aparecerán un desglose de conectores y un live artifact actualizable.',
