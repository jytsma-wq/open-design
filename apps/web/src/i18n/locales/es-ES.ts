...
export const esES: Dict = {
  ...
  'settings.orbit.emptyBodyManual': 'Usa «Ejecutar ahora» en el encabezado para iniciar tu primera ejecución; aquí aparecerán un desglose de conectores y un live artifact actualizable.',
