...
export const hu: Dict = {
  ...
  'settings.connectorsHelpUnsaved': 'Nem mentett módosítások — kattints a Mentésre, hogy a kulcs a helyi daemonba kerüljön, és feloldja az alábbi katalógust.',
  ...
  'settings.orbit.runOpen': 'Futtatás és megnyitás',
  ...
  'settings.orbit.emptyAria': 'Orbit még nem futott',
  'settings.orbit.emptyEyebrow': 'Első futásra vár',
  'settings.orbit.emptyTitle': 'A napi összefoglalód itt jelenik meg',
  'settings.orbit.emptyBodyScheduled': 'Orbit ütemezve van — a következő automatikus futás live artifactot és csatlakozó-aktivitási bontást tesz közzé ezen a kártyán.',
  'settings.orbit.emptyBodyManual': 'A fejlécben használd a „Futtatás és megnyitás” gombot az első futás indításához; itt jelenik meg a csatlakozók bontása és egy frissíthető live artifact.',
