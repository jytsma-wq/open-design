...
export const ru: Dict = {
  ...
  'settings.orbit.emptyBodyManual': 'Используйте «Запустить сейчас» в заголовке, чтобы выполнить первый запуск; здесь появятся разбивка коннекторов и обновляемый live artifact.',
