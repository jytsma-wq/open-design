...
export const ru: Dict = {
  ...
  'settings.connectorsHelpUnsaved': 'Есть несохранённые изменения — нажмите «Сохранить», чтобы записать этот ключ в локальный daemon и открыть каталог ниже.',
  ...
  'settings.orbit.runOpen': 'Запустить и открыть',
  ...
  'settings.orbit.emptyAria': 'Orbit еще не запускался',
  'settings.orbit.emptyEyebrow': 'Ожидание первого запуска',
  'settings.orbit.emptyTitle': 'Ваша ежедневная сводка появится здесь',
  'settings.orbit.emptyBodyScheduled': 'Orbit запланирован — следующий автоматический запуск опубликует live artifact и разбивку активности коннекторов в этой карточке.',
  'settings.orbit.emptyBodyManual': 'Используйте «Запустить и открыть» в заголовке, чтобы выполнить первый запуск; здесь появятся разбивка коннекторов и обновляемый live artifact.',
