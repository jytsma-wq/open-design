...
export const ar: Dict = {
  ...
  'settings.connectorsHelpUnsaved': 'تغييرات غير محفوظة — انقر حفظ لتخزين هذا المفتاح في daemon المحلي وفتح الكتالوج أدناه.',
  ...
  'settings.orbit.runOpen': 'تشغيل وفتح',
  ...
  'settings.orbit.emptyAria': 'لم يتم تشغيل Orbit بعد',
  'settings.orbit.emptyEyebrow': 'بانتظار أول تشغيل',
  'settings.orbit.emptyTitle': 'سيظهر ملخصك اليومي هنا',
  'settings.orbit.emptyBodyScheduled': 'Orbit مجدول — سينشر التشغيل التلقائي التالي live artifact وتفصيل نشاط الموصّلات في هذه البطاقة.',
  'settings.orbit.emptyBodyManual': 'استخدم “تشغيل وفتح” في الرأس لبدء أول تشغيل؛ سيظهر هنا تفصيل الموصّلات و live artifact قابل للتحديث.',
