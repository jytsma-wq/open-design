...
export const zhCN: Dict = {
  ...
  'settings.connectorsHelpUnsaved': '有未保存的更改 — 点击保存，将此密钥存入本地 daemon 并解锁下方目录。',
  ...
  'settings.orbit.emptyAria': 'Orbit 尚未运行',
  'settings.orbit.emptyEyebrow': '等待首次运行',
  'settings.orbit.emptyTitle': '你的每日摘要会显示在这里',
  'settings.orbit.emptyBodyScheduled': 'Orbit 已计划 — 下一次自动运行会在此卡片中发布一个 live artifact 和连接器活动明细。',
  'settings.orbit.emptyBodyManual': '使用页头中的“运行并打开”触发首次运行；连接器明细和可刷新的 live artifact 会显示在这里。',
