...
export const ko: Dict = {
  ...
  'settings.connectorsHelpUnsaved': '저장되지 않은 변경 사항 — 저장을 클릭하면 이 키가 로컬 daemon에 저장되고 아래 카탈로그가 열립니다.',
  ...
  'settings.orbit.runOpen': '실행 및 열기',
  ...
  'settings.orbit.emptyAria': 'Orbit이 아직 실행되지 않았습니다',
  'settings.orbit.emptyEyebrow': '첫 실행 대기 중',
  'settings.orbit.emptyTitle': '일일 요약이 여기에 표시됩니다',
  'settings.orbit.emptyBodyScheduled': 'Orbit이 예약되어 있습니다 — 다음 자동 실행이 이 카드에 live artifact와 커넥터 활동 분석을 게시합니다.',
  'settings.orbit.emptyBodyManual': '헤더의 “실행 및 열기”로 첫 실행을 시작하세요. 커넥터 분석과 새로고침 가능한 live artifact가 여기에 표시됩니다.',
