...
export const uk: Dict = {
  ...
  'settings.connectorsHelpUnsaved': 'Є незбережені зміни — натисніть «Зберегти», щоб записати цей ключ у локальний daemon і відкрити каталог нижче.',
  ...
  'settings.orbit.runOpen': 'Запустити й відкрити',
  ...
  'settings.orbit.emptyAria': 'Orbit ще не запускався',
  'settings.orbit.emptyEyebrow': 'Очікування першого запуску',
  'settings.orbit.emptyTitle': 'Ваш щоденний підсумок з’явиться тут',
  'settings.orbit.emptyBodyScheduled': 'Orbit заплановано — наступний автоматичний запуск опублікує live artifact і розбивку активності конекторів у цій картці.',
  'settings.orbit.emptyBodyManual': 'Скористайтеся «Запустити й відкрити» в заголовку, щоб виконати перший запуск; тут з’являться розбивка конекторів і оновлюваний live artifact.',
