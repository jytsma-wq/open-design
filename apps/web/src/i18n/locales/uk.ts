...
export const uk: Dict = {
  ...
  'settings.orbit.emptyBodyManual': 'Скористайтеся «Запустити зараз» в заголовку, щоб виконати перший запуск; тут з’являться розбивка конекторів і оновлюваний live artifact.',
