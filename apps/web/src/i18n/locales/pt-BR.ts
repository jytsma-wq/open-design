...
export const ptBR: Dict = {
  ...
  'settings.connectorsHelpUnsaved': 'Alterações não salvas — clique em Salvar para armazenar esta chave no daemon local e desbloquear o catálogo abaixo.',
  ...
  'settings.orbit.runOpen': 'Executar e abrir',
  ...
  'settings.orbit.emptyAria': 'Orbit ainda não foi executado',
  'settings.orbit.emptyEyebrow': 'Aguardando primeira execução',
  'settings.orbit.emptyTitle': 'Seu resumo diário aparecerá aqui',
  'settings.orbit.emptyBodyScheduled': 'Orbit está agendado — a próxima execução automática publicará um live artifact e um detalhamento da atividade dos conectores neste cartão.',
  'settings.orbit.emptyBodyManual': 'Use “Executar e abrir” no cabeçalho para acionar a primeira execução; um detalhamento de conectores e um live artifact atualizável aparecerão aqui.',
