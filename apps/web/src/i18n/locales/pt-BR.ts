...
export const ptBR: Dict = {
  ...
  'settings.orbit.emptyBodyManual': 'Use “Executar agora” no cabeçalho para acionar a primeira execução; um detalhamento de conectores e um live artifact atualizável aparecerão aqui.',
