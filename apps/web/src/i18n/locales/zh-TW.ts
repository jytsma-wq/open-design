...
export const zhTW: Dict = {
  ...
  'settings.connectorsHelpUnsaved': '有未儲存的變更 — 點擊儲存，將此金鑰存入本機 daemon 並解鎖下方目錄。',
  ...
  'settings.orbit.emptyAria': 'Orbit 尚未執行',
  'settings.orbit.emptyEyebrow': '等待首次執行',
  'settings.orbit.emptyTitle': '你的每日摘要會顯示在這裡',
  'settings.orbit.emptyBodyScheduled': 'Orbit 已排程 — 下一次自動執行會在此卡片中發布一個 live artifact 和連接器活動明細。',
  'settings.orbit.emptyBodyManual': '使用標頭中的「執行並開啟」觸發首次執行；連接器明細和可重新整理的 live artifact 會顯示在這裡。',
