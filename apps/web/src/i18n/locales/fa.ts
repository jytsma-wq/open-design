...
export const fa: Dict = {
  ...
  'settings.connectorsHelpUnsaved': 'تغییرات ذخیره‌نشده — روی ذخیره کلیک کنید تا این کلید در daemon محلی ذخیره شود و کاتالوگ پایین باز شود.',
  ...
  'settings.orbit.runOpen': 'اجرا و باز کردن',
  ...
  'settings.orbit.emptyAria': 'Orbit هنوز اجرا نشده است',
  'settings.orbit.emptyEyebrow': 'در انتظار اولین اجرا',
  'settings.orbit.emptyTitle': 'خلاصهٔ روزانهٔ شما اینجا نمایش داده می‌شود',
  'settings.orbit.emptyBodyScheduled': 'Orbit زمان‌بندی شده است — اجرای خودکار بعدی یک live artifact و تفکیک فعالیت کانکتورها را در این کارت منتشر می‌کند.',
  'settings.orbit.emptyBodyManual': 'از «اجرا و باز کردن» در سربرگ برای شروع اولین اجرا استفاده کنید؛ تفکیک کانکتورها و یک live artifact قابل تازه‌سازی اینجا ظاهر می‌شود.',
