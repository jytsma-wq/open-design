...
export const fa: Dict = {
  ...
  'settings.orbit.emptyBodyManual': 'از «همین حالا اجرا کن» در سربرگ برای شروع اولین اجرا استفاده کنید؛ تفکیک کانکتورها و یک live artifact قابل تازه‌سازی اینجا ظاهر می‌شود.',
