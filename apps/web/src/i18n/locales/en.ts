...
export const en: Dict = {
  ...
  'settings.connectorsHelpSaved': 'Your key unlocks the catalog below and stays in the local daemon. Paste a new key to replace it, or Clear to remove.',
  'settings.connectorsHelpUnsaved': 'Unsaved changes — click Save to store this key in the local daemon and unlock the catalog below.',
  'settings.connectorsHelpEmpty': 'Add a key to unlock the catalog below. Keys are stored locally in the daemon and never sent through environment variables.',
  ...
  'settings.orbit.emptyAria': 'Orbit has not run yet',
  'settings.orbit.emptyEyebrow': 'Awaiting first run',
  'settings.orbit.emptyTitle': 'Your daily summary will land here',
  'settings.orbit.emptyBodyScheduled': 'Orbit is scheduled — the next automatic run will publish a live artifact and a breakdown of connector activity in this card.',
  'settings.orbit.emptyBodyManual': 'Use Run it now in the header to trigger your first run; a connector breakdown and a refreshable live artifact will appear here.',
  ...
  'settings.orbit.gateBodyNoKey': 'Orbit summarizes activity across your connectors, and connectors run through Composio. Add a Composio API key in Connectors to unlock the catalog and pick your first integration.',
