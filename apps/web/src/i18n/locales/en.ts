...
export const en: Dict = {
  ...
  'settings.orbit.runOpen': 'Run & open',
  ...
  'settings.orbit.emptyBodyManual': 'Use Run & open in the header to trigger your first run; a connector breakdown and a refreshable live artifact will appear here.',
