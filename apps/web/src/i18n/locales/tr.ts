...
export const tr: Dict = {
  ...
  'settings.orbit.emptyBodyManual': 'İlk çalıştırmayı tetiklemek için başlıktaki “Şimdi çalıştır”ı kullanın; bağlayıcı dökümü ve yenilenebilir bir live artifact burada görünecek.',
