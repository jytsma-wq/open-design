...
export const tr: Dict = {
  ...
  'settings.connectorsHelpUnsaved': 'Kaydedilmemiş değişiklikler — bu anahtarı yerel daemon’a kaydetmek ve aşağıdaki kataloğu açmak için Kaydet’e tıklayın.',
  ...
  'settings.orbit.runOpen': 'Çalıştır ve aç',
  ...
  'settings.orbit.emptyAria': 'Orbit henüz çalışmadı',
  'settings.orbit.emptyEyebrow': 'İlk çalıştırma bekleniyor',
  'settings.orbit.emptyTitle': 'Günlük özetiniz burada görünecek',
  'settings.orbit.emptyBodyScheduled': 'Orbit zamanlandı — sonraki otomatik çalıştırma bu kartta bir live artifact ve bağlayıcı etkinliği dökümü yayımlayacak.',
  'settings.orbit.emptyBodyManual': 'İlk çalıştırmayı tetiklemek için başlıktaki “Çalıştır ve aç”ı kullanın; bağlayıcı dökümü ve yenilenebilir bir live artifact burada görünecek.',
