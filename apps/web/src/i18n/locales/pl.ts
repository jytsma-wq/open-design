...
export const pl: Dict = {
  ...
  'settings.connectorsHelpUnsaved': 'Niezapisane zmiany — kliknij Zapisz, aby zapisać ten klucz w lokalnym daemon i odblokować katalog poniżej.',
  ...
  'settings.orbit.runOpen': 'Uruchom i otwórz',
  ...
  'settings.orbit.emptyAria': 'Orbit nie był jeszcze uruchomiony',
  'settings.orbit.emptyEyebrow': 'Oczekiwanie na pierwsze uruchomienie',
  'settings.orbit.emptyTitle': 'Twoje dzienne podsumowanie pojawi się tutaj',
  'settings.orbit.emptyBodyScheduled': 'Orbit jest zaplanowany — następne automatyczne uruchomienie opublikuje live artifact i zestawienie aktywności konektorów w tej karcie.',
  'settings.orbit.emptyBodyManual': 'Użyj „Uruchom i otwórz” w nagłówku, aby wykonać pierwsze uruchomienie; tutaj pojawią się zestawienie konektorów i odświeżalny live artifact.',
