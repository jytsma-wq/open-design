...
export const pl: Dict = {
  ...
  'settings.orbit.emptyBodyManual': 'Użyj „Uruchom teraz” w nagłówku, aby wykonać pierwsze uruchomienie; tutaj pojawią się zestawienie konektorów i odświeżalny live artifact.',
